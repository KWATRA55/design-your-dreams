                                                    ...
                                                    <Tab.Pane  eventKey="first"  className={`fade ${show === 'first' ? 'show' : ''}`} id="chatbox1"  role="tabpanel">
                                                        ...
                                                        <div className="chat-content scroller">
                                                                ...
                                                                {chats ? chats.map((chat) => (
                                                                    ...
                                                                    {/* <span className="chat-time mt-1">{chat.timestamp}</span> */}
                                                                </div>
                                                        ...
                                                        <div className="chat-footer p-3 bg-white">
                                                            <Form className="d-flex align-items-center" action="#">
                                                                ...
                                                                <Form.Control type="text" className="me-3" placeholder="chat" id='chatbox' onChange={(e) => {setNewChat(e.target.value)}}/>
                                                                <Button type="submit" variant="primary d-flex align-items-center px-2" onClick={writeUserData}><i className="far fa-paper-plane" aria-hidden="true"></i><span className="d-none d-lg-block ms-1">Send</span></Button>
                                                            </Form>
                                                        </div>
                                                    </Tab.Pane>
